...
-(void)setFrame:(CGRect)frame {
    ...
    contentSize.height = contentSize.height; //MAX(contentSize.height, self.frame.size.height);
...
- (void)keyboardWillShow:(NSNotification*)notification {
	...
	[UIView setAnimationDidStopSelector:@selector(keyboardWillShowAnimationFinished)];
...
- (void)keyboardWillShowAnimationFinished {
