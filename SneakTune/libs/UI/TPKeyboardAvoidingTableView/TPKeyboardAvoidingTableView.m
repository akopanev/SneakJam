...
@synthesize avoidingDelegate = __avoidingDelegate;
...
- (void)keyboardWillShow:(NSNotification*)notification {
    ...
    if ( !firstResponder ) {
		// ako: second try - ask delegate for view
		if ([__avoidingDelegate respondsToSelector:@selector(viewToSearchForFirstResponder:)]) {
			firstResponder = [self findFirstResponderBeneathView:[__avoidingDelegate viewToSearchForFirstResponder:self]];
		}
